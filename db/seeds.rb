...
puts "Up load some sample Users:"

user1 = User.create!(first_name: "admin", last_name: "admin", e_mail: "admin@example.com", password: "password", password_confirmation: "password")
user3 = User.create!(first_name: "visitor", last_name: "visitor", e_mail: "visitor@example.com", password: "password", password_confirmation: "password")
user2 = User.create!(first_name: "Chang", last_name: "Li", e_mail: "changli@example.com", password: "password", password_confirmation: "password")
